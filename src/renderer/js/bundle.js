(() => {
  ...
  function posAtCoords(view, coords) {
    ...
    let caret2 = caretFromPoint(doc3, coords.left, coords.top);
    if (caret2)
      ({ node, offset } = caret2);
  ...
  var deleteSelection, joinBackward, joinTextblockBackward, joinTextblockForward, selectNodeBackward, joinForward, selectNodeForward, joinUp, joinDown, lift2, newlineInCode, exitCode, createParagraphNear, liftEmptyBlock, splitBlock, selectParentNode, selectAll, selectTextblockStart, selectTextblockEnd, backspace, del, pcBaseKeymap, macBaseKeymap, mac4;
  ...
  var init_dist16 = __esm({
    "node_modules/@tiptap/core/dist/index.js"() {
      ...
      setContent = (content, emitUpdate = false, parseOptions = {}, options2 = {}) => ({ editor, tr: tr2, dispatch, commands: commands2 }) => {
        var _a, _b;
        const { doc: doc3 } = tr2;
...
.tippy-box[data-animation=fade][data-state=hidden] {
  ...
  var ListItemName, TextStyleName, inputRegex2, BulletList;
  ...
  var ListItemName2, TextStyleName2, inputRegex4, OrderedList;
  ...
  var inputRegex6, TaskItem;
  var init_dist44 = __esm({
    "node_modules/@tiptap/extension-task-item/dist/index.js"() {
      init_dist16();
      inputRegex6 = /^\s*(\[([( |x])?\])\s$/;
      TaskItem = Node2.create({
        name: "taskItem",
        addOptions() {
          return {
            nested: false,
  ...
  var readFromCache, addToCache, TableMap, tableEditingKey, CellSelection, CellBookmark, fixTablesKey, toggleHeaderRow, toggleHeaderColumn, toggleHeaderCell, handleKeyDown2, TableView, columnResizingPluginKey, ResizeState;
  var init_dist45 = __esm({
    "node_modules/prosemirror-tables/dist/index.js"() {
      ...
      CellSelection = class CellSelection2 extends Selection {
      ...
      CellBookmark = class CellBookmark2 {
        constructor(anchor, head) {
          this.anchor = anchor;
          this.head = head;
        }
      ...
      columnResizingPluginKey = new PluginKey("tableColumnResizing");
      ResizeState = class ResizeState2 {
...
3. "-" cannot repeat`);
  ...
  var encodedTlds, encodedUtlds, numeric, ascii, alpha, asciinumeric, alphanumeric, domain, emoji, scheme, slashscheme, whitespace, ta, tr, ts, tt, WORD, UWORD, ASCIINUMERICAL, ALPHANUMERICAL, LOCALHOST, TLD, UTLD, SCHEME, SLASH_SCHEME, NUM, WS, NL, OPENBRACE, CLOSEBRACE, OPENBRACKET, CLOSEBRACKET, OPENPAREN, CLOSEPAREN, OPENANGLEBRACKET, CLOSEANGLEBRACKET, FULLWIDTHLEFTPAREN, FULLWIDTHRIGHTPAREN, LEFTCORNERBRACKET, RIGHTCORNERBRACKET, LEFTWHITECORNERBRACKET, RIGHTWHITECORNERBRACKET, FULLWIDTHLESSTHAN, FULLWIDTHGREATERTHAN, AMPERSAND, APOSTROPHE, ASTERISK, AT, BACKSLASH, BACKTICK, CARET, COLON, COMMA, DOLLAR, DOT, EQUALS, EXCLAMATION, HYPHEN, PERCENT, PIPE, PLUS, POUND, QUERY, QUOTE, FULLWIDTHMIDDLEDOT, SEMI, SLASH, TILDE, UNDERSCORE, EMOJI$1, SYM, tk, ASCII_LETTER, LETTER, EMOJI, DIGIT, SPACE, CR, LF, EMOJI_VARIATION, EMOJI_JOINER, OBJECT_REPLACEMENT, tlds, utlds, defaults, Email, Text2, Nl, Url, makeState, warn, warnAdvice, INIT;
  var init_linkify = __esm({
    "node_modules/linkifyjs/dist/linkify.mjs"() {
      encodedTlds = "\xF6";
      ...
      appendTransaction: (transactions, oldState, newState) => {
        ...
        changes.forEach(({ newRange }) => {
          ...
          if (textBlock && textBeforeWhitespace) {
            ...
            }).filter((link2) => options2.validate(link2.value)).filter((link2) => options2.shouldAutoLink(link2.value)).forEach((link2) => {
              if (getMarksBetween(link2.from, link2.to, newState.doc).some((item) => item.mark.type === options2.type)) {
                return;
              }
              tr2.addMark(link2.from, link2.to, options2.type.create({
                href: link2.href
              }));
            });
          }
    ...
    return new Plugin({
      ...
      props: {
        handlePaste: (view, event, slice2) => {
          ...
          const link2 = find(textContent, { defaultProtocol: options2.defaultProtocol }).find((item) => item.isLink && item.value === textContent);
  ...
  var UNICODE_WHITESPACE_PATTERN, UNICODE_WHITESPACE_REGEX, UNICODE_WHITESPACE_REGEX_END, UNICODE_WHITESPACE_REGEX_GLOBAL, Link;
  ...
  var init_marked_esm = __esm({
    "node_modules/marked/lib/marked.esm.js"() {
      ...
      autolink2 = edit(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex();
  ...
  var require_app = __commonJS({
    "src/renderer/js/app.js"() {
      ...
      var MDownerApp = class {
        ...
        toggleHeading(level) {
          if (!this.editor || !this.isEditorReady) return;
          const isActive2 = this.editor.isActive("heading", { level });
          if (isActive2) {
        ...
        // 更新按钮状态
        updateButtonState(id, isActive2) {
          const button = document.getElementById(id);
          if (button) {
            if (isActive2) {
        ...
        updateOutline() {
          ...
          if (!outline) return;
          const headings = [];
          const doc3 = this.editor.state.doc;
          doc3.descendants((node, pos) => {
          ...
          outline.innerHTML = headings.map((heading2) => `
      <div class="outline-item" data-level="${heading2.level}" data-pos="${heading2.pos}">
        ${heading2.text}
      </div>
    `).join("");
        ...
        initContextMenu() {
          ...
          const findLink = (target) => {
            ...
            if (link2 && link2.href && /^https?:\/\//i.test(link2.href)) {
              return link2.href;
            }
            return null;
          };
